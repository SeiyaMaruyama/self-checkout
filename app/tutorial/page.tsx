    ...
    return (
        <section className="w-full h-screen flex flex-col items-center justify-center space-y-8 bg-gray-100 dark:bg-gray-900">
            ...
            <ol className="list-decimal list-inside space-y-4 text-lg text-gray-700 dark:text-gray-300">
                <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded">Step 1: Do something</li>
                <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded">Step 2: Do something else</li>
                <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded">Step 3: Do something different</li>
                <li className="bg-gray-200 dark:bg-gray-800 p-4 rounded">Step 4: Complete the process</li>
            </ol>
